# src/runtime/sim_st_closed_loop.py
"""
...
Usage:
    python src/runtime/sim_st_closed_loop.py [options]
    
Example:
    python src/runtime/sim_st_closed_loop.py --V_ref 48 --Vin_dropped 18 --t_drop_start 0.1
